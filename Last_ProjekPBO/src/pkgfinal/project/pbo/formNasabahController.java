...
public class formNasabahController implements Initializable {
    ...
    @FXML
    private TableView<Individu> tabelNasabah;
    @FXML
    ...
    @FXML
    private TableColumn<Individu, Integer> kolomJumlah;
    @FXML
    private TableView<Rekening> tabelRekening;
    @FXML
    private TableColumn<Rekening, Integer> kolomNoRek;
    @FXML
    ...
    @FXML
    private TableColumn<Perusahaan, Integer> kolomIDPerusahaan;
    @FXML
    private TableColumn<Perusahaan, String> kolomNamaPerusahaan;
    @FXML
    private TableColumn<Perusahaan, String> kolomAlamatPerusahaan;
    @FXML
    private TableColumn<Perusahaan, String> kolomNIB;
    @FXML
    private TableColumn<Perusahaan, Integer> kolomJumlahPerusahaan;
    @FXML
    private TableView<Rekening> tabelRekeningPerusahaan;
    @FXML
    private TableColumn<Rekening, Integer> kolomNoRekPerusahaan;
    @FXML
    private TableColumn<Rekening, Double> kolomSaldoPerusahaan;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tabelNasabah.getSelectionModel().selectedIndexProperty().addListener(listener->{
            if(tabelNasabah.getSelectionModel().getSelectedItem() != null){
                Individu akun = tabelNasabah.getSelectionModel().getSelectedItem();
        ...
        tabelNasabahPerusahaan.getSelectionModel().selectedIndexProperty().addListener(listener->{
            if(tabelNasabahPerusahaan.getSelectionModel().getSelectedItem() != null){
                Perusahaan akun = tabelNasabahPerusahaan.getSelectionModel().getSelectedItem();
    ...
    private void handleRefreshNasabah(ActionEvent event) {
        try{
            ObservableList<Individu> data = datamodel.getIndividu();
    ...
    private void handleAddRekening(ActionEvent event) {
        try{
            datamodel.addRekening(Integer.parseInt(textIDBaru.getText()), new Rekening(Integer.parseInt(textNoRekeningBaru.getText()), Double.parseDouble(textSaldoBaru.getText())));
    ...
    public void viewRekening(int id){
        try{
            ObservableList<Rekening> data = datamodel.getRekening(id);
    ...
    private void handleAddNasabahPerusahaan(ActionEvent event) {
        ...
        Perusahaan nasabahBaru = new Perusahaan(
    ...
    private void handleRefreshNasabahPerusahaan(ActionEvent event) {
        try{
            ObservableList<Perusahaan> data = datamodel.getPerusahaan();
    ...
    private void handleAddRekeningPerusahaan(ActionEvent event) {
        try{
            datamodel.addRekening(Integer.parseInt(textIDBaruPerusahaan.getText()), new Rekening(Integer.parseInt(textNoRekeningBaruPerusahaan.getText()), Double.parseDouble(textSaldoBaruPerusahaan.getText())));
